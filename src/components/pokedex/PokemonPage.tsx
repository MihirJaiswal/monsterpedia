        ...
        <div className="flex flex-col md:flex-row justify-around">
            ...
            >
              ...
              <aside className="flex flex-col p-6 h-full">
                <nav className="flex flex-col space-y-4 mt-16">
                  ...
                  <Link href='/pokedex'>
                    <button className={`py-3 px-5 rounded-lg text-left transition-transform transform hover:scale-105 focus:outline-none`}>
                      <div className='flex items-center justify-center gap-2'>
                        <span className='font-semibold'>Pokedex</span>
                        <p className='text-gray-800 text-lg'><FaArrowAltCircleLeft /></p>
                      </div>
                    </button>
                  </Link>
                </nav>
          ...
          <div className="md:ml-64 flex-1 mt-8 md:mt-2">
            ...
            {activeSection === 'section3' && (
              <MovesSection moves={pokemon.moves} pokemonName={pokemon.name} />
            )}
