...
const PokemonCard: React.FC<PokemonCardProps> = ({ pokemon, onRemove }) => {
  return (
    <div className="rounded-lg shadow-lg p-4 flex flex-col items-center w-60 mx-auto bg-white bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 border border-gray-100">
     ...
     <img
      ...
      <button
        ...
        className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition duration-200 m-4"
      >
        Remove {pokemon.name}
      </button>
     </div>
